...
bot = telebot.TeleBot('5560230230:AAHKxXO6oFIp2z8ndD3BUKdj-PLhKbnN_sQ')
...
def callback_worker(call):
    ...
    if user_state == YEAR_SELECTION_STATE:
        ...
        bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text='Выбери направление',
